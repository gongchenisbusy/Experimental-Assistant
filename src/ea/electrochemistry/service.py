    ...
    if method != "reviewed_offset_conversion":
        warnings.append(
            _warning(
                ...
                "Only reviewed_offset_conversion is supported for electrochemistry potential conversion in this Experimental Assistant v1.1.0 workflow.",
                severity="medium",
    ...
    if method != "reviewed_ir_drop_correction":
        warnings.append(
            _warning(
                ...
                "Only reviewed_ir_drop_correction is supported for iR drop correction in this Experimental Assistant v1.1.0 workflow.",
                severity="medium",
                requested_method=method,
            )
        )
    ...
    if method != "reviewed_tafel_linear_fit":
        warnings.append(
            _warning(
                ...
                "Only reviewed_tafel_linear_fit is supported for Tafel analysis in this Experimental Assistant v1.1.0 workflow.",
                severity="medium",
                requested_method=method,
            )
        )
    ...
    if method != "reviewed_gcd_discharge_metrics":
        warnings.append(
            _warning(
                ...
                "Only reviewed_gcd_discharge_metrics is supported for GCD analysis in this Experimental Assistant v1.1.0 workflow.",
                severity="medium",
                requested_method=method,
            )
        )
    ...
    if method != "reviewed_eis_circuit_fit":
        warnings.append(
            _warning(
                ...
                "Only reviewed_eis_circuit_fit is supported for EIS circuit fitting in this Experimental Assistant v1.1.0 workflow.",
                severity="medium",
                requested_method=method,
            )
        )
    ...
    if circuit_model not in {"series_r_rc", "randles_rc"}:
        warnings.append(
            _warning(
                ...
                "Only a reviewed series_r_rc EIS circuit-fit screening model is supported in this Experimental Assistant v1.1.0 workflow.",
                severity="medium",
