...
This guide defines the maintainer and recipient checks for Experimental Assistant v1.1.0. Repository: <https://github.com/gongchenisbusy/Experimental-Assistant>. Release: <https://github.com/gongchenisbusy/Experimental-Assistant/releases/tag/v1.1.0>.
...
- `experimental_assistant-1.1.0-py3-none-any.whl`
- `experimental_assistant-1.1.0.tar.gz`
- `experimental-assistant-1.1.0-skills.zip`
- `experimental-assistant-1.1.0-skills.zip.sha256`
- `experimental-assistant-v1.1.0-release-manifest.yml`
- `experimental-assistant-1.1.0-COMMIT-release.zip`
- `experimental-assistant-1.1.0-COMMIT-release.zip.sha256`
- `experimental-assistant-1.1.0-sbom.json`
- `experimental-assistant-1.1.0-vulnerability-report.json`
- `experimental-assistant-v1.1.0-distribution-checklist.json`
- `experimental-assistant-v1.1.0-distribution-checklist.md`
...
ea setup --codex-home /path/to/disposable-codex-home --json
ea doctor --json
ea --help
```
...
`ea-release-supply-chain` generates a CycloneDX 1.5 SBOM and `pip-audit` report from the clean release environment. Scanner unavailability, scanner error, or any unallowlisted known vulnerability is release-blocking. The v1.1.0 allowlist is empty. See `docs/RELEASE_SECURITY_POLICY.md` and `requirements/release.txt`.
...
- `ea-release-checklist`: consolidated release status for git, package, skill bundle, supply chain, and artifacts.
