...
| [#4 short-test context pressure](https://github.com/gongchenisbusy/Experimental-Assistant/issues/4) | Implemented; native CI confirmed | 10 KB router budget, 2 KB wrapper budget, draft/status layer, explicit modes, compact output tests, UTF-8/Chinese import fixtures, and passing Windows/Ubuntu/macOS CI in [run 29102557775](https://github.com/gongchenisbusy/Experimental-Assistant/actions/runs/29102557775). |
