...
- y 轴说明 counts、normalized intensity 或 reviewed background-subtracted intensity；若显示扣背景曲线，必须能追溯到用户确认的 `background_subtraction` 方法、区域、锚点/窗口和方法参数，例如 Shirley 迭代设置或 Tougaard U2 的 kernel、`B`、`C_eV2`、integration direction。
