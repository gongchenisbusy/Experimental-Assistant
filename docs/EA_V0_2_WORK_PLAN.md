...
- 用户能通过 `ea literature acceptance-checklist` 生成本地文献工作流公开验收清单，看到初始化、检索/排序、确认、获取、导入、reconciliation 和公开边界的 ready/missing/not-applicable 状态。
