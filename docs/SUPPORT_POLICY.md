...
v0.9.7 targets Python 3.11, 3.12, and 3.13 on native Windows, Ubuntu, and macOS CI runners. Python 3.14 is observation-only until the complete release gate passes.
