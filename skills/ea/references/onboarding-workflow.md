...
The onboarding message should identify Experimental Assistant v0.9.8, present `$ea` as the only skill invocation, and remind the user to restart Codex after skill installation or replacement.
