...
The onboarding message should identify Experimental Assistant v0.9.7, mention the internal compatibility id `ea-v0-2`, and remind the user to restart Codex after skill installation or replacement.
