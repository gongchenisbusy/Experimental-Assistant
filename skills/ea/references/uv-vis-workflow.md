...
Use this reference when processing UV-Vis absorbance, transmittance, or reflectance spectra in the Experimental Assistant v0.9.7 compatibility skill.
...
Current Experimental Assistant v0.9.7 UV-Vis compatibility support:
