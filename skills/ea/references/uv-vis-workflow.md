...
Use this reference when processing UV-Vis absorbance, transmittance, or reflectance spectra in the Experimental Assistant v1.0.0 skill.
...
Current Experimental Assistant v1.0.0 UV-Vis compatibility support:
