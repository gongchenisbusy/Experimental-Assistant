...
Use this reference when preparing the Experimental Assistant v1.0.0 repository for public handoff or a release checkpoint.
...
ea-sign-release-package dist/experimental-assistant-1.0.0-abcdef0-release.zip --private-key /path/to/user-release-private.pem --public-key /path/to/user-release-public.pem
ea-verify-release-signature dist/experimental-assistant-1.0.0-abcdef0-release.zip --public-key /path/to/user-release-public.pem
...
python3 scripts/verify_release_package.py dist/experimental-assistant-1.0.0-abcdef0-release.zip
...
python3 scripts/sign_release_package.py dist/experimental-assistant-1.0.0-abcdef0-release.zip --private-key /path/to/user-release-private.pem --public-key /path/to/user-release-public.pem
python3 scripts/verify_release_signature.py dist/experimental-assistant-1.0.0-abcdef0-release.zip --public-key /path/to/user-release-public.pem
...
- Writes `dist/experimental-assistant-v1.0.0-release-manifest.yml` by default.
...
- Writes `dist/experimental-assistant-1.0.0-{commit}-release.zip` by default.
- Writes a `.zip.sha256` sidecar next to the archive.
- Stores all archive members under one top-level directory.
- Includes `experimental-assistant-v1.0.0-release-manifest.yml` inside the archive.
...
- Finds the embedded `experimental-assistant-v1.0.0-release-manifest.yml`.
...
- Writes `dist/experimental-assistant-v1.0.0-distribution-checklist.json` and `dist/experimental-assistant-v1.0.0-distribution-checklist.md` by default.
