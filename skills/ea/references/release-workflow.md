...
Use this reference when preparing the Experimental Assistant v0.9.9 repository for public handoff or a release checkpoint.
...
ea-release-manifest
ea-release-package
ea-verify-release-package dist/experimental-assistant-0.9.9-abcdef0-release.zip
ea-release-keygen --private-key /path/to/user-release-private.pem --public-key /path/to/user-release-public.pem
ea-sign-release-package dist/experimental-assistant-0.9.9-abcdef0-release.zip --private-key /path/to/user-release-private.pem --public-key /path/to/user-release-public.pem
ea-verify-release-signature dist/experimental-assistant-0.9.9-abcdef0-release.zip --public-key /path/to/user-release-public.pem
...
python3 scripts/verify_release_package.py dist/experimental-assistant-0.9.9-abcdef0-release.zip
...
python3 scripts/sign_release_package.py dist/experimental-assistant-0.9.9-abcdef0-release.zip --private-key /path/to/user-release-private.pem --public-key /path/to/user-release-public.pem
python3 scripts/verify_release_signature.py dist/experimental-assistant-0.9.9-abcdef0-release.zip --public-key /path/to/user-release-public.pem
...
- Writes `dist/experimental-assistant-v0.9.9-release-manifest.yml` by default.
...
- Writes `dist/experimental-assistant-0.9.9-{commit}-release.zip` by default.
- Writes a `.zip.sha256` sidecar next to the archive.
- Stores all archive members under one top-level directory.
- Includes `experimental-assistant-v0.9.9-release-manifest.yml` inside the archive.
...
- Finds the embedded `experimental-assistant-v0.9.9-release-manifest.yml`.
...
- Writes `dist/experimental-assistant-v0.9.9-distribution-checklist.json` and `dist/experimental-assistant-v0.9.9-distribution-checklist.md` by default.
