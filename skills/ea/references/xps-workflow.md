...
Use this reference when processing X-ray photoelectron spectroscopy spectra in the Experimental Assistant v0.9.9 skill.
...
Current Experimental Assistant v0.9.9 XPS compatibility support:
