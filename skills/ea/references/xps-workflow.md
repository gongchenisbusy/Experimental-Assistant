...
Use this reference when processing X-ray photoelectron spectroscopy spectra in the Experimental Assistant v1.0.0 skill.
...
Current Experimental Assistant v1.0.0 XPS compatibility support:
