...
Use this reference when processing X-ray diffraction patterns in the Experimental Assistant v0.9.7 compatibility skill.
...
Current Experimental Assistant v0.9.7 XRD compatibility support:
