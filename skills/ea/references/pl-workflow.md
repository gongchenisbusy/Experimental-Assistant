...
Use this reference when processing photoluminescence spectra in the Experimental Assistant v0.9.9 skill.
...
Current Experimental Assistant v0.9.9 PL compatibility support:
