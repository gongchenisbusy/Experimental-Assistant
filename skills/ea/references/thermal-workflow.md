...
Use this reference when processing tabular TGA, DSC, or DTG-style thermal analysis data in the Experimental Assistant v1.1.0 skill.
...
Current Experimental Assistant v1.1.0 thermal compatibility support:
