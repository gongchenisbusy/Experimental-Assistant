...
ea-sign-release-package dist/experimental-assistant-0.9.8-COMMIT-release.zip --private-key /path/to/user-release-private.pem --public-key /path/to/user-release-public.pem
ea-verify-release-signature dist/experimental-assistant-0.9.8-COMMIT-release.zip --public-key /path/to/user-release-public.pem
```
