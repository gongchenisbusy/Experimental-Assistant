...
Use this reference when processing X-ray diffraction patterns in the Experimental Assistant v0.9.6 compatibility skill.
...
Current Experimental Assistant v0.9.6 XRD compatibility support:
