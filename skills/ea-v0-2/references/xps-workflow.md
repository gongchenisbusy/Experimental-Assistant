...
Use this reference when processing X-ray photoelectron spectroscopy spectra in the Experimental Assistant v0.9.6 compatibility skill.
...
Current Experimental Assistant v0.9.6 XPS compatibility support:
