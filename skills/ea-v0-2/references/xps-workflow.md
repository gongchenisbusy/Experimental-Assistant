...
- Public release packages include `examples/public-xps-be-project/`, a public-safe runnable example of the built-in C 1s/Si 2p BE candidate path from source packet and reference registration through suggestion review package, report display, and draft interpretation memory candidates.
