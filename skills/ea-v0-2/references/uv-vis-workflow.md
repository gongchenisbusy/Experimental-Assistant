...
Use this reference when processing UV-Vis absorbance, transmittance, or reflectance spectra in the Experimental Assistant v0.9.5 compatibility skill.
...
Current Experimental Assistant v0.9.5 UV-Vis compatibility support:
