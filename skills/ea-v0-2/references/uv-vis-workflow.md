...
8. Use `ea uv-vis compare-replicates` when two or more processed UV-Vis metadata records should be summarized together; require explicit metadata paths and do not infer replicate membership silently.
