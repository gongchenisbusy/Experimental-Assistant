...
Future UV-Vis work should add numeric baseline/substrate/reference correction algorithms after review, replicate comparison, richer material assignment libraries, and richer multi-candidate memory review helpers.
