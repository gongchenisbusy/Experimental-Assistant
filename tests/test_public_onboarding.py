...
def test_public_onboarding_doc_is_public_safe_and_actionable() -> None:
    ...
    assert "# Experimental Assistant v0.9.7 Public Onboarding" in text
...
def test_public_install_and_skill_setup_doc_is_public_safe_and_actionable() -> None:
    ...
    assert "Product identity: `Experimental Assistant v0.9.7`" in text
    assert (
    ...
    assert (
        "https://github.com/gongchenisbusy/Experimental-Assistant/releases/tag/v0.9.7"
        in text
    )
