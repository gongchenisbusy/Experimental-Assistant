...
README_TEXT = """# Experimental Assistant v0.9.7 Public XPS Binding-Energy Candidate Example

This folder is a packaged, public-safe EA project example for the XPS source-backed binding-energy candidate workflow. It is meant for inspection, smoke testing, and agent orientation after installing or unpacking an Experimental Assistant v0.9.7 package.
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Build the packaged Experimental Assistant v0.9.7 public XPS BE candidate example project.")
