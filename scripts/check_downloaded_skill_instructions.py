...
REQUIRED_FILES = [
    ...
    Path("skills/ea/references/interaction-modes.md"),
...
REQUIRED_STRINGS = [
    ...
    "ea update",
    "ea rollback",
    "ea --mode audit references validate-report",
    "ea --mode audit export verify-bundle",
    "ea --mode audit export verify-archive",
    "EA-MODE-COMMAND-BLOCKED",
    "ea import preview",
    "--characterization-type",
    "ea draft confirm-promote",
    "ea experiment add",
    "ea sample select-best",
    "ea composite-report",
    "--draft-id",
    "ea migrate plan",
    "ea literature setup-preflight",
    "ea literature acquisition-status",
    "ea literature ingest-local-pdf",
    "ea brief project",
