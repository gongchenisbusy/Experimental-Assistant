...
README_TEXT = """# Experimental Assistant v0.9.9 Public Raman Example Project

This folder is a packaged, public-safe EA project example. It is meant for inspection, smoke testing, and agent orientation after installing or unpacking an Experimental Assistant v0.9.9 package.
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Build the packaged Experimental Assistant v0.9.9 public Raman example project.")
