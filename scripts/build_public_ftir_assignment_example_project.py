...
README_TEXT = """# Experimental Assistant v0.9.8 Public FTIR Assignment Example

This folder is a packaged, public-safe EA project example for the FTIR source-backed assignment workflow. It is meant for inspection, smoke testing, and agent orientation after installing or unpacking an Experimental Assistant v0.9.8 package.
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Build the packaged Experimental Assistant v0.9.8 public FTIR assignment example project.")
