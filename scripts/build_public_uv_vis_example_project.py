...
README_TEXT = """# Experimental Assistant v0.9.7 Public UV-Vis Example

This folder is a packaged, public-safe EA project example for the UV-Vis reviewed optical-screening workflow. It is meant for inspection, smoke testing, and agent orientation after installing or unpacking an Experimental Assistant v0.9.7 package.
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Build the packaged Experimental Assistant v0.9.7 public UV-Vis example project.")
