...
README_TEXT = """# EA v0.2 Public UV-Vis Example

This folder is a packaged, public-safe EA project example for the UV-Vis reviewed optical-screening workflow. It is meant for inspection, smoke testing, and agent orientation after installing or unpacking an Experimental Assistant v0.9.6 package.
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Build the packaged EA v0.2 public UV-Vis example project.")
